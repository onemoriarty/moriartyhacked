...
from src.Commands.Methods_L4.discord import discord
...
{lightwhite}.DISCORD           {gray}Discord UDP Attack 
...
def command_line(client, username):
    ...
    while 1:
        try:
            ...
            elif command == '.DISCORD':  # Discord UDP Flood
                discord(args, validate_ip, validate_port, validate_time, send, client, ansi_clear, broadcast, data)
